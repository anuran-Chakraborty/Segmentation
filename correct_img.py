...
dir_name_list =["Shameem Ahmed","Anwit Mondal","Khalid Hassan Sk","Krishnendu Mukhopadhyay","saikat chakraborty"]  #put appropriate name of folder

for dir_name in os.listdir('./Data'):
	data_dir = "./Data/"+dir_name+"/gt"
	print(dir_name)
